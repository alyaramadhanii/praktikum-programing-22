print()
print('praktikum-b5')
print('Nama Lengkap: Alya Ramadhani')
print('NIM         : 231031037')
print('prodi       : Sistem Informasi')
print()

nim = [2,3,1,0,3,1,0,3,7]
print(nim)
# akses item
